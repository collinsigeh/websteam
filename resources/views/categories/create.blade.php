    ...
    <div class="mb-4"> 
        ...
        <form action="{{ route('categories.store') }}" method="post" class="form-card">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="name" placeholder="Name of new category" name="category_name"  value="{{ old('category_name') }}" autocomplete="category_name" required>
